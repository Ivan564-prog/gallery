...
class RegisterMissionarySerializer(PhoneSerializerValidator, BaseRegisterSerializer):
...
class RegisterChiefSerializer(PhoneSerializerValidator, BaseRegisterSerializer):
